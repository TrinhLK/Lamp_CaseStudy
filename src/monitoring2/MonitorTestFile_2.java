...
public class MonitorTestFile_2 {
	private ActorSystem system;
    private EngineFactory engineFactory;
    static final Logger logger = LoggerFactory.getLogger(MonitorTestFile_2.class);
...
//		final BIPActor mysql2_executor = engine.register(mysql2, "mysql2", true);
		...
		tomcat1.setBIPActor(tomcat1_executor);
		tomcat2.setBIPActor(tomcat2_executor);
...
//		final BIPActor apache2_executor = engine.register(apache2, "apache2", true);
		...
		engine.execute();
		logger.info("get Tomcat1 actor: " + tomcat1.getTomcatActor());
		logger.info("get Tomcat2 actor: " + tomcat2.getTomcatActor());
...
//		}
    ...
    public static void main(String[] args) {
    	...
    	MonitorTestFile_2 testLamp = new MonitorTestFile_2();
		testLamp.initialize();
