...
//		port(C_SystemsMonitor.class, "VMdown").requires(C_VirtualMachine.class, "pause");
		...
		port(C_MySQL.class, "running").accepts(C_Tomcat.class, "start", "running", C_SystemsMonitor.class,"VMready", C_VirtualMachine.class, "running");
		port(C_SystemsMonitor.class,"VMready").accepts(C_MySQL.class, "running", C_Tomcat.class, "start", C_VirtualMachine.class, "running");

		//configure
		port(C_MySQL.class, "configure").accepts(C_VirtualMachine.class, "running", C_SystemsMonitor.class, "VMready");
		port(C_Tomcat.class, "configure").accepts(C_VirtualMachine.class, "running", C_SystemsMonitor.class, "VMready");
		port(C_SystemsMonitor.class, "VMready").accepts(C_VirtualMachine.class, "running", C_MySQL.class, "configure", C_Tomcat.class, "configure");
		port(C_VirtualMachine.class, "running").accepts(C_SystemsMonitor.class, "VMready", C_MySQL.class, "configure", C_Tomcat.class, "configure");
		port(C_MySQL.class, "running").accepts(C_Tomcat.class, "configure");
		
		//stop
//		port(C_Tomcat.class, "stop").accepts(C_VirtualMachine.class, "running", C_SystemsMonitor.class, "VMready");
//		port(C_SystemsMonitor.class, "VMready").accepts(C_VirtualMachine.class, "running", C_Tomcat.class, "stop");
//		port(C_VirtualMachine.class, "running").accepts(C_SystemsMonitor.class, "VMready", C_Tomcat.class, "stop");
		port(C_Tomcat.class, "stop").requires(C_MySQL.class, "makeError");
		port(C_MySQL.class, "makeError").requires(C_Tomcat.class, "stop");
		port(C_Tomcat.class, "stop").accepts(C_MySQL.class, "makeError");
		port(C_MySQL.class, "makeError").accepts(C_Tomcat.class, "stop");
//		port(C_Tomcat.class, "stop").acceptsNothing();
		/**
		 * Data transfer
		 * */
...
//		data(C_Tomcat.class, "tomcatActor1").to(C_MySQL.class, "tomcatActor1");
	}
