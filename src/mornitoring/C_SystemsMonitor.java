...
public class C_SystemsMonitor {
	...
	@Transitions({
		...
		@Transition(name = "VMready", source = "1", target = "1", guard = "canConnect"),
	})
	public void vmReady() {
		String[] vmInfo1 = vmInfo.split("-");
//		vmInfo = _vId;
		logger.info("Monitor: {" + vmInfo1[0] + "} is {" + vmInfo1[1] + "}.\n");
	}
...
//		vmList.put(vmInfo[0], vmInfo[1]);
	...
	@Data(name = "vmInfo", accessTypePort = AccessType.any)
	public String getvId() {
		return vmInfo;// + "-" + runningTime;
	}
